...
public class CrossoverFactory {
  ...
  public static Crossover getCrossoverOperator(String name, HashMap parameters) throws JMException {
    ...
    else if(name.equalsIgnoreCase("AProductLineSinglePointCrossover")){
    	 return new AProductLineSinglePointCrossover(parameters);
    }else if(name.equalsIgnoreCase("JinghuiCrossover")){
   	 return new JinghuiCrossover(parameters);
   }
    else {
