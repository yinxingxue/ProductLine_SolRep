...
public class DominanceComparator implements Comparator {
  ...
  */
   ...
   */
    ...
    //return extractOldDominanceTest(solution1, solution2, dominate1, dominate2);
  } // compare
 ...
 * @return
 */
public int extractOldDominanceTest(Solution solution1, Solution solution2, int dominate1, int dominate2) {
	int flag;
  ...
  private int dominanceTest(Solution solution1, Solution solution2) {
	    ...
	    if (solution1Dominates == solution2Dominates) {
	      ...
	      result = 0;
	    } else if (solution1Dominates && !solution2Dominates) {
	      // solution1 dominates
	      result = -1;
	    } else if (solution2Dominates && !solution1Dominates){
	      // solution2 dominates
	      result = 1;
	    }
	    return result;
