...
public class Spread {
   ...
   */
  public double spread(double [][] front1, 
                       double [][] trueParetoFront1,
                       int         numberOfObjectives1) {
	  
	  double[][] front=front1;
	  double[][] trueParetoFront=trueParetoFront1;
	  int numberOfObjectives= numberOfObjectives1;
	  if(GAParams.P_usingOptimalOnly) {
		  front=GAParams.removeNonCorrect(front1);
		  trueParetoFront=GAParams.removeNonCorrect(trueParetoFront1);
	  }
	  if(GAParams.P_addBackMandatory && GAParams.P_filterMandatory) {
		  front=GAParams.addBackMandatory(front1);
		  trueParetoFront=GAParams.addBackMandatory(trueParetoFront1);
	  }
