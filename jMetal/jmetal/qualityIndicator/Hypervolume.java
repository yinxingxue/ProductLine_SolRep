...
public class Hypervolume {
  ...
  */
   ...
   */
  public double hypervolume(double [][] paretoFront1, 
                            double [][] paretoTrueFront1,
                            int numberOfObjectives1) {
	  

	  double[][] paretoFront=paretoFront1;
	  double[][] paretoTrueFront=paretoTrueFront1;
	  int numberOfObjectives= numberOfObjectives1;
	  if(GAParams.P_usingOptimalOnly) {
		  paretoFront=GAParams.removeNonCorrect(paretoFront1);
		  paretoTrueFront=GAParams.removeNonCorrect(paretoTrueFront1);
	  }
	  
	  if(GAParams.P_addBackMandatory && GAParams.P_filterMandatory) {
		  paretoFront=GAParams.addBackMandatory(paretoFront1);
		  paretoTrueFront=GAParams.addBackMandatory(paretoTrueFront1);
	  }
