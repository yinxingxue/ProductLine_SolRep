 ...
 * @author chris
 */
public class SATIBEA_SinglePointCrossover extends Crossover {
  /**
   * Valid solution types to apply this operator 
   */
  private static final List VALID_TYPES = Arrays.asList(SATIBEA_BinarySolution.class, BinarySolutionType.class,
   ...
   */
  public SATIBEA_SinglePointCrossover(HashMap<String, Object> parameters) {
  	super(parameters) ;
    ...
    try {
      if (PseudoRandom.randDouble() < probability) {
        if ((parent1.getType().getClass() == BinarySolutionType.class) ||
            (parent1.getType().getClass() == BinaryRealSolutionType.class) || parent1.getType().getClass() == SATIBEA_BinarySolution.class) {
